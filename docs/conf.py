# -*- coding: utf-8 -*-
#
# debugtools documentation build configuration file, created by
...
version = debugtools.__version__
# The full version, including alpha/beta/rc tags.
release = debugtools.__version__
...
man_pages = [
    ('index', 'cookiecutterproject_name', u'debugtools Documentation',
     [u'Kale Kundert'], 1)
]
